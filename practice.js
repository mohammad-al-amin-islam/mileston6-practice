...
const student = {
    ...
    income:0,
    firends:[1,23,45],
    treaday:function(cost){
        return cost;
    }
}
/* const reamain = student.treaday(12);
console.log(reamain);
 */
...
/* const tempateString = `
id:${student.educationalInfo.id}
friends:${student.firends[2]}
name:${student.name}
`
console.log(tempateString); */
...
const sumAndDevidedBy2 = (a,b) =>(a+b)/2;
//console.log(sumAndDevidedBy2(2,3));
...
const res = array.map(ele => ele/7);
//console.log(res);

//৫. জাভাস্ক্রিপ্ট এ array এর map, forEach, filter, find কোনটা দিয়ে কি হয়। সেটার একটা সামারি লিখে ফেলো। 

/*
with map it will return all value with given work into an array
foreach-- it will only do console log it will not rerurn any variable
filter -- filter will find the variable that is in condition an return it in array
find -- will return first in condition array though there is multiple thing if cant find any it will return undefind;
*/
...
const {name,age} = object2;
//console.log(name);

const [one,balance] = array;
//console.log(balance);
